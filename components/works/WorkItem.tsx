...
const WorkItem: React.FC<Project> = ({ title, image, link, technologies, description }) => {
  const techArray = technologies.split(',');

  return (
    <div className='post-box mb-8 fadeInUp-animation'>
      <div className='bg-white grid grid-cols-1 shadow-lg hover:shadow-xl transition-all duration-300'>
        ...
        <div className='p-6'>
          ...
          <Link href={link} className='text-amber-500' target='_blank'>Visit web site <Link2 className='inline-flex' /></Link>
